        ...
        <div className="bg-slate-950 text-slate-300 px-4 py-1.5 text-xs flex flex-wrap items-center justify-between gap-2 border-b border-slate-800/80">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
            ...
            <a
              ...
              className="flex items-center gap-1 text-[11px] text-blue-300 hover:text-white px-2.5 py-0.5 rounded-lg bg-blue-950/60 border border-blue-500/40 hover:bg-blue-800/40 transition cursor-pointer font-medium"
              title="Visit Official HENZ Facebook Page"
            >
