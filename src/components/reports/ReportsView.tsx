                ...
                <tr key={tx.id} className="hover:bg-[#1a202c] transition">
                  ...
                  <td className="py-3 px-3 text-center">
                    <button
                      ...
                      className="px-2.5 py-1 bg-[#0d1117] hover:bg-[#1c232d] text-gray-200 border border-[#30363d] rounded-lg text-xs font-bold transition flex items-center gap-1 mx-auto cursor-pointer"
                    >
